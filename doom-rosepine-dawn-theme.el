;;; doom-rosepine-dawn-theme.el --- Doom Emacs theme port of Rose Pine Dawn -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-rosepine-dawn-theme nil
  "Options for the `doom-rosepine-dawn' theme."
  :group 'doom-themes)

(defcustom doom-rosepine-dawn-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-rosepine-dawn-theme
  :type 'boolean)

(defcustom doom-rosepine-dawn-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-rosepine-dawn-theme
  :type 'boolean)

(defcustom doom-rosepine-dawn-comment-bg doom-rosepine-dawn-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'doom-rosepine-dawn-theme
  :type 'boolean)

(defcustom doom-rosepine-dawn-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-rosepine-dawn
    "A dark theme inspired by Rose Pine"
  :family 'doom-rosepine-dawn
  :background-mode 'dark

  ;; name        default   256       16
  (
   ;; Rose Pine main palette
   (rp-base       '("#faf4ed" "black"   "black"  ))
   (rp-surface    '("#fffaf3" "black"   "black"  ))
   (rp-overlay    '("#f2e9e1" "grey"    "grey"   ))
   (rp-muted      '("#9893a5" "grey"    "grey"   ))
   (rp-subtle     '("#797593" "grey"    "grey"   ))
   (rp-text       '("#464261" "white"   "white"  ))
   ...
   (selection      nil)
   (builtin        rp-foam)
   (comments       (if doom-rosepine-dawn-brighter-comments rp-pine rp-muted))
   (doc-comments   (doom-lighten (if doom-rosepine-dawn-brighter-comments rp-pine rp-muted) 0.25))
   (constants      rp-iris)
   (functions      rp-rose)
   (keywords       rp-pine)
   (methods        rp-foam)
   ...
   ;; custom categories
   (hidden     (car bg))
   (-modeline-bright doom-rosepine-dawn-brighter-modeline)
   (-modeline-pad
    (when doom-rosepine-dawn-padded-modeline
      (if (integerp doom-rosepine-dawn-padded-modeline) doom-rosepine-dawn-padded-modeline 4)))
  ...
  ((hl-line :background rp-highlight-low)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-rosepine-dawn-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (font-lock-doc-face
...
;;; doom-rosepine-dawn-theme.el ends here
