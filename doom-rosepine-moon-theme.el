;;; doom-rosepine-moon-theme.el --- inspired by Rose Pine -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-rosepine-moon-theme nil
  "Options for the `doom-rosepine-moon' theme."
  :group 'doom-themes)

(defcustom doom-rosepine-moon-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-rosepine-moon-theme
  :type 'boolean)

(defcustom doom-rosepine-moon-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-rosepine-moon-theme
  :type 'boolean)

(defcustom doom-rosepine-moon-comment-bg doom-rosepine-moon-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-rosepine-moon-theme
  :type 'boolean)

(defcustom doom-rosepine-moon-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-rosepine-moon
    "A dark theme inspired by Rose Pine"
  :family 'doom-rosepine-moon
  :background-mode 'dark

  ;; name        default   256       16
  (
   ;; Rose Pine main palette
   (rp-base       '("#232136" "black"   "black"  ))
   (rp-surface    '("#2a273f" "black"   "black"  ))
   (rp-overlay    '("#393552" "grey"    "grey"   ))
   ...
   (rp-rose       '("#ea9a97" "cyan"    "cyan"   ))
   (rp-pine       '("#3e8fb0" "blue"    "blue"   ))
   (rp-foam       '("#9ccfd8" "cyan"    "cyan"   ))
   (rp-iris       '("#c4a7e7" "magenta" "magenta"))
   (rp-leaf       '("#95b1ac" "green"   "green"  ))
   ;; Rose Pine highlight colors
   (rp-highlight-low  '("#2a283e" "grey" "grey"))
   (rp-highlight-med  '("#44415a" "grey" "grey"))
   (rp-highlight-high '("#56526e" "grey" "grey"))
   ...
   (selection      nil)
   (builtin        rp-foam)
   (comments       (if doom-rosepine-moon-brighter-comments rp-pine rp-muted))
   (doc-comments   (doom-lighten (if doom-rosepine-moon-brighter-comments rp-pine rp-muted) 0.25))
   (constants      rp-iris)
   (functions      rp-rose)
   (keywords       rp-pine)
   (methods        rp-foam)
   ...
   ;; custom categories
   (hidden     (car bg))
   (-modeline-bright doom-rosepine-moon-brighter-modeline)
   (-modeline-pad
    (when doom-rosepine-moon-padded-modeline
      (if (integerp doom-rosepine-moon-padded-modeline) doom-rosepine-moon-padded-modeline 4)))
  ...
  ((hl-line :background rp-highlight-low)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-rosepine-moon-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (font-lock-doc-face
...
;;; doom-rosepine-moon-theme.el ends here
